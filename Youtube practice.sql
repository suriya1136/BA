CREATE DATABASE IF NOT EXISTS YTDB;
USE YTDB;
...
-- Find out how much employees made sales
...
SELECT first_name, last_name FROM employee WHERE emp_id IN
	(SELECT emp_id FROM works_with GROUP BY emp_id HAVING SUM(total_sales) > 50000);
...
SELECT client_name FROM client WHERE client_id IN
	(SELECT client_id FROM works_with GROUP BY client_id HAVING SUM(total_sales) > 100000);
...
VALUES(111, 'Oscar', 'sudhu', '1968-02-19', 'M', 69000, 106, 3);
...
DELIMITER ;
INSERT INTO employee
VALUES(112, 'Kevin', 'Malone', '1978-02-19', 'M', 69000, 106, 3);
...
INSERT INTO employee
VALUES(113, 'Pam', 'Beesly', '1988-02-19', 'F', 69000, 106, 3);

DROP TRIGGER my_trigger;

DELIMITER ;
INSERT INTO employee
VALUES(117, 'deepa', NULL, NULL, 'F', NULL, NULL, NULL);
